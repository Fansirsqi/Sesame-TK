...
import static fansirsqi.xposed.sesame.hook.RequestManager.requestJson;
...
//        doAllMemberAvailableTask();
    ...
    public void memTaskListQueryFacade() throws JSONException {
        ...
        try {
            requestString = requestJson("com.alipay.amic.memtask.h5.MemTaskListQueryFacade.signPageTaskList", "\"source\": \"antmember\",\"sourcePassMap\": {\"innerSource\": \"\",\"source\": \"myTab\",\"unid\": \"\"},\"spaceCode\": \"ant_member_xlight_task\",\"taskTopConfigId\": \"\"");
        } finally {
        }
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (!valueByPath.isEmpty()) {
                JSONObject requestString2 = requestJson("com.alipay.adtask.biz.mobilegw.service.task.finish", "\"bizId\": \"" + valueByPath + "\",\"extendInfo\": {}");
                TimeUtil.sleep(2000);
