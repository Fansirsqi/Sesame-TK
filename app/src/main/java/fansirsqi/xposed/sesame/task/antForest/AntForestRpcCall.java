...
public class AntForestRpcCall {
    ...
    public static String medical_health_feeds_query() {
        return RequestManager.requestString(
                ...
                "[{\"activityCode\":\"medical_health_feeds_query\",\"activityId\":\"2023072600001207\",\"body\":{\"apiVersion\":\"3.1.0\",\"bizId\":\"B213\",\"businessCode\":\"JKhealth\",\"businessId\":\"O2023071900061804\",\"cityCode\":\"330100\",\"cityName\":\"杭州\",\"exclContentIds\":[],\"filterItems\":[]," +
                        "\"latitude\":\"\",\"longitude\":\"\",\"moduleParam\":{\"COMMON_FEEDS_BLOCK_2024041200243259\":{}},\"pageCode\":\"YM2024041200137150\",\"pageNo\":1,\"pageSize\":10,\"pid\":\"BC_PD_20230713000008526\",\"queryQuizActivityFeed\":1,\"scenceCode\":\"HEALTH_CHANNEL\",\"schemeParams\":{}," +
                        "\"scope\":\"PARTIAL\",\"selectedTabCode\":\"\",\"sourceType\":\"miniApp\",\"specialItemId\":\"\",\"specialItemType\":\"\",\"tenantCode\":\"2021003141652419\",\"underTakeContentId\":\"\"},\"version\":\"2.0\"}]");
    }
     ...
     * @throws JSONException JSON 解析异常
     */
    public static String queryTaskModel(String chInfo, boolean skipTaskList) throws JSONException {
        JSONObject jo = new JSONObject();
     ...
     * @throws JSONException JSON 解析异常
     */
    public static String taskSignUp(String taskBizId,String taskCode, String taskSource, String taskType) throws JSONException {
        JSONObject jo = new JSONObject();
     ...
     * @return
     */
    public static String taskComplete(String taskBizId, String taskCode, String taskSource, String taskType) {
        ...
        try {
            ...
            return RequestManager.requestString("alipay.membertangram.biz.rpc.student.taskComplete", new JSONArray().put(params).toString());
