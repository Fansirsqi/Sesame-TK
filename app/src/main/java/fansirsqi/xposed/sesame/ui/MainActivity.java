...
//        viewHandler = new Handler(Looper.getMainLooper());
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.btn_github) {//主页的按钮调试debug
            data += Files.getDebugLogFile().getAbsolutePath();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            ...
            //请求
            menu.add(0, 10, 10, R.string.test_post);
            menu.add(0, 11, 11, R.string.debug_tips);
        } catch (Exception e) {
            Log.printStackTrace(e);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case 11:
                ...
                debugData += Files.getDebugLogFile().getAbsolutePath();
            ...
            case 9:
                ...
                break;
            case 10:
                Intent rpcDebugIntent = new Intent(this, RpcDebugActivity.class);
